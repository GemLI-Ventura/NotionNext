...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'GemLI', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个来自泥的电硬件爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.gemli.cn', // 网站地址
